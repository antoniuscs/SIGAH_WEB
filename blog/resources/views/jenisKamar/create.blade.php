...
<div id="page-content-wrapper">
    <div class="container-fluid">
        <div class="box">
            ...
            <br><br>
            <form class="" action="{{ route('jenisKamar.store') }}" method="post" enctype="multipart/form-data">
                <script>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" maxlength="50" name="nama_jenis_kamar" placeholder = "Nama Jenis Kamar" required autofocus>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" maxlength="2" name="kode_jenis_kamar" placeholder = "Kode Jenis Kamar" required>
                </div>

                <div class="form-group">
                    <label for="detail_jenis_kamar">Detail Jenis Kamar</label><br>
                    <textarea rows="5" name="detail_jenis_kamar" class="form-control" placeholder = "Detail Jenis Kamar" required></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" onkeypress="return hanyaAngka(event)" maxlength="2" class="form-control" 
                    name="kapasitas" placeholder = "Kapasitas" required>
                </div>

                <div class="form-group">
                    <label for="harga">Harga</label>
                    <input type="text" onkeypress="return hanyaAngka(event)" maxlength="12" class="form-control" name="harga_jenis_kamar" maxlength="2" placeholder = "Harga" required>
                </div>
